  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="h-screen overflow-hidden bg-primary">
        <div className="mx-auto flex h-screen max-h-[900px] max-w-[1400px] items-center">
          <div className="flex flex-col place-self-start">
            ...
            <div className="relative h-[660px]">
              ...
              <img
                src={buildings}
                className="absolute bottom-0 left-[8rem] z-10 w-[25rem]"
              />
              ...
              <img
                src={cloud}
                className="absolute bottom-[65%] left-[40%] z-0"
              />
              <img
                src={bird}
                className="absolute bottom-[6%] left-[24%] z-30"
